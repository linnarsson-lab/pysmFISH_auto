...
def create_general_analysis_config_file(config_db_path:str):
    ...
    analysis_parameters['eel-barcoded']['ROBOFISH2']['small-beads']['PreprocessingFishFilteringLaplacianKernel'] = (0.2,0.1,0.1)
    ...
    analysis_parameters['eel-barcoded']['ROBOFISH2']['large-beads']['PreprocessingFishFilteringLaplacianKernel'] = (0.2,0.1,0.1)
