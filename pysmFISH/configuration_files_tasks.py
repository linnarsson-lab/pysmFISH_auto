...
from pysmFISH.logger_utils import prefect_logging_setup, function_logger
...
class create_specific_analysis_config_file(Task):
    """
    ...
    def run(self, experiment_fpath:str, experiment_info:Dict):
        ...
        analysis_config_fpath = experiment_fpath.parent / 'pipeline_config' / 'analysis_config.yaml'
        analysis_config = OrderedDict()

        general_analysis_config = yaml.safe_load(general_analysis_config_fpath, 'rb')
        ...
        analysis_config = general_analysis_config[machine]
...
class load_experiment_config_file(Task):
    """
    Task that load the experiment general information generated by the
    machines.
    ...
    def run(self, experiment_fpath:str):
        ...
        try:
            ...
            self.logger.error(f'No experiment info file in {experiment_fpath}')
            ...
            try:
                ...
                self.logger.error(f'Experiment info file has the wrong name in {experiment_fpath}')
