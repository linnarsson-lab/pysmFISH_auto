...
class Output_models():
    ...
    def __init__(self):
        ...
        self.output_variables_specific_registration = ['r_px_registered', 'r_px_registered',
        ...
        self.output_registration_df = pd.DataFrame(columns=self.output_variables_dot_calling)

        self.output_variables_barcodes = self.output_variables_registration + self.output_variables_specific_barcodes
        self.barcode_analysis_df = pd.DataFrame(columns=self.output_variables_dot_calling)
