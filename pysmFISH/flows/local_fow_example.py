...
if __name__ == '__main__':
    ...
    with Flow("test_running") as flow:
        ...
        saved_beads_data = save_dots_data.map(beads_counts)
        ...
        registration_combinations = hybridizations_registration_grps(experiment_info,upstream_tasks=[saved_beads_data])
