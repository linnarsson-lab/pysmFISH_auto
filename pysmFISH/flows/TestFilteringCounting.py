...
with Flow("filtering-counting",environment=LocalEnvironment(DaskExecutor(address='tcp://193.10.16.58:10735')),
    ...
    filtered_fish_images_metadata = fish_counter.map(zarr_grp_name=sorted_grps[0][0:2000],
