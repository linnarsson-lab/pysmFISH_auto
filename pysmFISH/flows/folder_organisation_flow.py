...
from pysmFISH.utilities_tasks import organise_files_tmp
from pysmFISH.utilities_tasks import sort_data_into_folders
...
with Flow("folder-organization",environment=LocalEnvironment(DaskExecutor(address='tcp://193.10.16.58:9234')),
    ...
    data_sorter = sort_data_into_folders()
    sorted_data = data_sorter(experiment_fpath,experiment_info)
    sorted_data.set_upstream(folders)
